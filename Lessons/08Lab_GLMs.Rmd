...
EPAair %>% 
  ...
  labs(y = "Density", x = "Ozone AQI Value", fill = "Density Plot: Ozone by year")
...
# ozone is independent; pm 2.5 is dependent

e1 <- lm(formula = PM2.5 ~ Ozone, data = EPAair)
summary(e1)

# p value so low, strong positive relationship
# but ozone only explains 13% of the variability (from r square)
