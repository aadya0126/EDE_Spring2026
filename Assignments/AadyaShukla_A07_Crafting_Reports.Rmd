...
```{r boxplot.2018, fig.height = 3.5, fig.cap = "Monthly Ozone (2018)", fig.align='left', echo=FALSE, message=FALSE, warning=FALSE}

# Creating levels for months
...
#levels(epa_data$Month)

ggplot(subset(epa_data, Year == "2018")) + 
  geom_boxplot(aes(x = Month, y = Ozone)) + 
  scale_x_discrete(drop = FALSE) + 
  theme(axis.title.x = element_blank()) +
  labs(title = "Monthly Ozone: 2018", y = expression(
    paste("Ozone", , "(", mu, "g/", m^3, ")"))
       )

```

```{r boxplot.2019, fig.height = 3.5, fig.cap = "Monthly Ozone (2019)", fig.align='left', echo=FALSE, message=FALSE, warning=FALSE}

ggplot(subset(epa_data, Year == "2019")) + 
  geom_boxplot(aes(x = Month, y = Ozone)) + 
  scale_x_discrete(drop = FALSE) + 
  theme(axis.title.x = element_blank()) + 
  labs(title = "Monthly Ozone: 2019", y = expression(
    paste("Ozone", , "(", mu, "g/", m^3, ")"))
       )
...
https://github.com/aadya0126/EDE_Spring2026

I did not use AI in the completion of this assignment.
Aadya Shukla, 03/01/2026
